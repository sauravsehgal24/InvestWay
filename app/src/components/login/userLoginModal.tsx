...
import { Button, Checkbox, Fade, FormControlLabel, makeStyles, Snackbar, TextField, Typography } from "@material-ui/core";
...
const UserLogin:React.FC<UserLoginProps> = (props:UserLoginProps)=>{
    ...
    const [snacBarObj, setSnackBarObj] = React.useState({open:false,message:""})
    ...
    return (
        ...
        >
          ...
          <div className={classes.paper}>
             {
                 props.type==="QS"?<h1>Comming Soon</h1>:fadeModal()
             }
          </div>
        </Fade>
        </Modal>
